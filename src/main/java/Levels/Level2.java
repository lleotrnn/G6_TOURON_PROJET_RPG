...
public class Level2 {
    ...
    public Level2() {
        ...
        Story.secondLevelIntro();

        this.wizard = Level1.wizard;
        this.enemy = Enemy.Basilisk();
    ...
    public void usePotion() {
        ...
        if (potionChoice == 1) {
            ...
            Display.printTextWithColor("You have used a potion and restored 50 health points!", Color.GREEN);
        } else {
            playersActions();
        }
    }
